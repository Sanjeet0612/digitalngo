<aside class="sidebar">
    ...
    <div>
        <a href="{{url('/')}}/dashboard" class="sidebar-logo">
            <img src="{{ asset('assets/images/logo_mahror.jpeg') }}" alt="site logo" class="light-logo">
            <img src="{{ asset('assets/images/logo_mahror.png') }}" alt="site logo" class="dark-logo">
            <img src="{{ asset('assets/images/logo_mahror.jpeg') }}" alt="site logo" class="logo-icon">
        </a>
    </div>
