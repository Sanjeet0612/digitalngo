                ...
                <table class="table bordered-table sm-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center">Donation For</th>
                    ...
                    <tbody>
                        @foreach($allCausesDonation as $allCausesDonationVal)
                        <tr>
                            <td>01</td>
                            <td class="text-center">{{$allCausesDonationVal->donation_date}}</td>
                            <td class="text-center">{{$allCausesDonationVal->cause->title}}</td>
                            <td class="text-center">{{$allCausesDonationVal->donation_amt}}</td>
                            @if($allCausesDonationVal->is_paid==0)
                            <td class="text-center text-warning">Not Paid</td>
                            @else
                            <td class="text-center text-success">Paid</td>
                            @endif
                            <td class="text-center"><a href="{{route('cause_donation',$allCausesDonationVal->causes_id)}}" class="btn btn-success">Donate Now</a></td>
                            <!--<td>
