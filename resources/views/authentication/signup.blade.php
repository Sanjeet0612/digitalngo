    ...
    <section class="auth bg-base d-flex flex-wrap">
        ...
        <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
            <div class="max-w-464-px mx-auto w-100">
                ...
                <form action="{{url('/')}}/authentication/signup" method="post">
                    @csrf
                    <div class="icon-field mb-16">
                        <span class="icon top-50 translate-middle-y">
                            <iconify-icon icon="f7:person"></iconify-icon>
                        </span>
                        <input type="text" name="username" value="{{ old('username') }}" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Username">
                    </div>
                    <div class="icon-field mb-16">
                        <span class="icon top-50 translate-middle-y">
                    ...
                    <div class="mb-20">
                        <div class="position-relative ">
                            ...
                            <span onchange="togglePwd(this)" class="toggle-password ri-eye-line cursor-pointer position-absolute end-0 top-50 translate-middle-y me-16 text-secondary-light" data-toggle="#your-password"></span>
                        </div>
                    ...
                    <div class="icon-field mb-16">
                        ...
                        <input type="text" name="refer_username" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Refer Code (Optional)" fdprocessedid="d6zyom">
                    </div>
                    <div class="">
...
document.querySelectorAll('.toggle-password').forEach(icon => {
    icon.addEventListener('click', function () {
        const input = this.previousElementSibling.querySelector('.password-input')
