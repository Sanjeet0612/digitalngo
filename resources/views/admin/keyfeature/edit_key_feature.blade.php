...
@php
    $title='Edit & Update Key Features';
    $subTitle = 'Edit & Update Key Features';
                ...
                <div class="col-lg-12">
                    ...
                    @endif
                        ...
                        <div class="card-header border-bottom">
                            <h6 class="text-xl mb-0">Add New Features</h6>
                        </div>
                        <div class="card-body p-24">
                            <form id="myForm" action="{{route('admin.update_key_feature',$featureDetail->id)}}" method="post" class="d-flex flex-column gap-20" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                <div class="col-sm-4">
                                    <label class="form-label fw-bold text-neutral-900" for="title">Title: </label>
                                    <input type="text" name="title" value="{{$featureDetail->title}}" class="form-control border border-neutral-200 radius-8" id="title" placeholder="Enter Title">
                                </div>
                                <div class="col-sm-4">
                                    <label class="form-label fw-bold text-neutral-900" for="title">Phone: </label>
                                    <input type="text" name="phone" value="{{$featureDetail->phone}}" class="form-control border border-neutral-200 radius-8" id="phone" placeholder="Enter Phone No">
                                </div>
                                <div class="col-sm-4">
                                <div class="mb-20">
                                    ...
                                    <select class="form-control radius-8 form-select" name="status" id="status">
                                        <option value="1" @if($featureDetail->status==1) selected @endif >Active</option>
                                        <option value="0" @if($featureDetail->status==0) selected @endif> Deactive</option>
                                    </select>
                                </div>
                            </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="border border-neutral-200 radius-8 overflow-hidden">
                                        <div class="height-200">
                                            ...
                                            <!-- Editor start -->
                                            <div id="editor">{!! $featureDetail->description !!}</div>
                                ...
                                <div>
                                    ...
                                    @if(!empty($featureDetail->icon_img))
                                        <img src="{{url('/')}}/{{$featureDetail->icon_img}}" style="width: 55px;">
                                    @endif
