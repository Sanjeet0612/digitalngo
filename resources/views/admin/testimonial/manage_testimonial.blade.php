...
@section('content')
    ...
    <div class="card h-100 p-0 radius-12">
        <div class="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-between">
            ...
            <a href="#" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    ...
                    <form action="{{route('admin.add_testimonial')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-6 mb-20">
                                ...
                                <input type="text" id="name" name="name" class="form-control radius-8"  placeholder="Enter Name">
                            </div>
                             <div class="col-6 mb-20">
                                <label for="profile_img" class="form-label fw-semibold text-primary-light text-sm mb-8"> Profile Image </label>
                                <input type="file" id="profile_img" name="profile_img" class="form-control radius-8" >
                            </div>
