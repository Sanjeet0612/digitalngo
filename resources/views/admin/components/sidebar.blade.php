    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a  href="{{route('admin.manage_category')}}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Category</a>
                    </li>
                    <li>
            ...
            <li class="dropdown">
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a  href="{{route('admin.causes_category')}}"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Causes Category</a>
                    </li>
                    <li>
