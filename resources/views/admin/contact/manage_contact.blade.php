...
@php
    ...
    $subTitle = 'Manage Contact Detail';
    $script ='<script>
...
@section('content')
            ...
            <div class="card h-100 p-0 radius-12">
                <div class="card-header border-bottom bg-base py-16 px-24 d-flex align-items-center flex-wrap gap-3 justify-content-between">
                    ...
                    <a  href="{{route('admin.add_contact')}}" class="btn btn-primary text-sm btn-sm px-12 py-12 radius-8 d-flex align-items-center gap-2">
