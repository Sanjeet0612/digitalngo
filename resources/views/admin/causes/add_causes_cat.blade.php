...
@php
    $title='Add Causes Category';
    $subTitle = 'Add Causes Category';
                ...
                <div class="col-lg-12">
                    ...
                    @endif
                        ...
                        <div class="card-body p-24">
                            <form id="myForm" action="{{route('admin.add_key_feature')}}" method="post" class="d-flex flex-column gap-20" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                <div class="col-sm-4">
