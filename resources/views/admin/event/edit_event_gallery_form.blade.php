...
@php
    $title='Update Event Gallery';
    $subTitle = 'Update Gallery Images';
                        ...
                        <div class="card-body p-24">
                            <form id="myForm" action="{{route('admin.update-event-gallery',$eventGallDetail->id)}}" method="post" class="d-flex flex-column gap-20" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <input type="file" name="gallery_img" class="form-control border border-neutral-200 radius-8" id="gallery_img">
