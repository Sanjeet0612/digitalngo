...
@php
    $title='Edit & Update Partners';
    $subTitle = 'Edit & Update Partners';
                ...
                <div class="col-lg-12">
                    ...
                    @endif
                        ...
                        <div class="card-body p-24">
                            <form id="myForm" action="{{route('admin.update_partners',$partnerData->id)}}" method="post" class="d-flex flex-column gap-20" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                <div class="col-sm-12">
                                <div class="mb-20">
                                    ...
                                    <select class="form-control radius-8 form-select" name="status" id="status">
                                        <option value="1" @if($partnerData->status==1) selected @endif >Active</option>
                                        <option value="0" @if($partnerData->status==0) selected @endif>Deactive</option>
                                    </select>
                                </div>
                            </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <img src="{{url('/')}}/{{$partnerData->logo}}" style="width:120px;">
                                    @endif
