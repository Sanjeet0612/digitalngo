                ...
                <div class="col-lg-12">
                    <div class="card mt-24">
                        ...
                        <div class="card-body p-24">
                            <form id="myForm" action="{{route('admin.add_article_category')}}" method="post" class="d-flex flex-column gap-20" enctype="multipart/form-data">
                                @csrf
                                <div>
