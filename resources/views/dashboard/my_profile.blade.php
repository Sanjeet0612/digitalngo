...
@section('content')
            ...
            <div class="row gy-4">
                <div class="col-lg-4">
                    ...
                    <?php
                    if(empty($user->bg_img)){
                        ?> <img src="{{ asset('assets/images/user-grid/NGOBanner.png') }}" alt="" class="w-100 object-fit-cover"> <?php
                    }else{
                        ?> <img src="{{asset('storage/'.$user->bg_img)}}" alt="" class="w-100 object-fit-cover"> <?php
                    }
                    ?>
                    <div class="pb-24 ms-16 mb-24 me-16  mt--100">
                            <div class="text-center border border-top-0 border-start-0 border-end-0">
                                ...
                                if(empty($user->profile_img)){
                                    ...
                                    ?> <img src="{{asset('storage/'.$user->profile_img)}}" alt="" class="border br-white border-width-2-px w-200-px h-200-px rounded-circle object-fit-cover" ><?php
                                }
                                ?>
                            ...
                            <div class="mt-24">
                                ...
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center gap-1 mb-12">
                                        ...
                                        <span class="w-70 text-secondary-light fw-medium">: {{ $user->pan_num }}</span>
                                    </li>
                                    <li class="d-flex align-items-center gap-1 mb-12">
                                        <span class="w-30 text-md fw-semibold text-primary-light"> Aadhar No.</span>
                                        <span class="w-70 text-secondary-light fw-medium">: {{ $user->adhar_num }}</span>
                                    </li>
                                    <li class="d-flex align-items-center gap-1 mb-12">
                                    ...
                                    <li class="d-flex align-items-center gap-1 mb-12">
                                        ...
                                        <span class="w-70 text-secondary-light fw-medium">: {{ $user->zipcode }}</span>
                                    </li>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="tab-pane fade show active" id="pills-edit-profile" role="tabpanel" aria-labelledby="pills-edit-profile-tab" tabindex="0">
                     <form action="{{url('/')}}/users/update-profile" method="POST" enctype="multipart/form-data">
                                    @csrf              
                                            ...
                                            <div class="avatar-preview">
                                                <div class="avatar-preview">
                                                    ...
                                                    if(empty($user->profile_img)){
                                                        ...
                                                        ?><div><img src="{{ asset('storage/'.$user->profile_img) }}"> </div> <?php
                                                    }
                                                    ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="text" name="name" value="{{$user->name}}" class="form-control radius-8" id="name" placeholder="Enter Full Name">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    <label for="email" class="form-label fw-semibold text-primary-light text-sm mb-8">Email <span class="text-danger-600">*</span></label>
                                                    <input type="email" name="email" value="{{$user->email}}" readonly class="form-control radius-8" id="email" placeholder="Enter email address">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    <label for="number" class="form-label fw-semibold text-primary-light text-sm mb-8">Phone</label>
                                                    <input type="text" name="phone" value="{{$user->phone}}" class="form-control radius-8" id="number" placeholder="Enter phone number">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="text" name="pan_num" value="{{$user->pan_num}}" class="form-control radius-8" id="pannumber" placeholder="Enter PAN number">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    <label for="aadharnumber" class="form-label fw-semibold text-primary-light text-sm mb-8">Aadhar NO.</label>
                                                    <input type="text" name="adhar_num" value="{{$user->adhar_num}}" class="form-control radius-8" id="aadharnumber" placeholder="Enter Aadhar number">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    <label for="address" class="form-label fw-semibold text-primary-light text-sm mb-8">Address</label>
                                                    <input type="text" name="address" value="{{$user->address}}" class="form-control radius-8" id="address" placeholder="Enter Address">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    <label for="city" class="form-label fw-semibold text-primary-light text-sm mb-8">City</label>
                                                    <input type="text" name="city" value="{{$user->city}}" class="form-control radius-8" id="city" placeholder="Enter City">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="text" name="state" value="{{$user->state}}" class="form-control radius-8" id="state" placeholder="Enter State">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <input type="text" name="zipcode" value="{{$user->zipcode}}" class="form-control radius-8" id="zipcode" placeholder="Enter Zipcode">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    {{-- PAN --}}
                                                    @if($user->pan_img)
                                                        <img src="{{ route('pan', basename($user->pan_img)) }}" style="width:100px;">
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    {{-- Aadhaar --}}
                                                    @if($user->adhar_img)
                                                        <img src="{{ route('adhar', basename($user->adhar_img)) }}" style="width:100px;">
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    {{-- Background Banner --}}
                                                    @if($user->bg_img)
                                                        <img src="{{ asset('storage/'.$user->bg_img) }}" style="width:100px;">
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-20">
                                                    ...
                                                    <textarea name="bio" class="form-control radius-8" id="desc" placeholder="Write description..."></textarea>
                                                </div>
                                            </div>
                                        </div>
